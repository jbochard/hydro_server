ang.service('nurseriesService', ['$http', function($http) {
	...
	this.patch_set_plant_in_bucket = function(nursery_id, nursery_pos, plant_id, resultFn, errorFn) {
		var url = host + '/nurseries/' + nursery_id;
		var data = { op: "SET_PLANT_IN_BUCKET", value: { position: nursery_pos, plant_id: plant_id } };
